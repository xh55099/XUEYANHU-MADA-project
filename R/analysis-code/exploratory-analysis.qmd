...
# Fit the DA model using cross-validation
lda_model <- train(formula = formula_CV_DA,
                   data = mydata,
                   method = "lda",             # Use LDA method
                   trControl = train_control2,  # Use defined training control
